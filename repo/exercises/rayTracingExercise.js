...
function setTextures(){
   ...
   let UVGridTexture = textureLoader.load(
...
function groundRectangleF()
{
   //------------------------------------------------------------------------------------
	...
	groundRectangle.material.ior = 1.5; // range: 1.0(air) to 2.33(diamond) / default is 1.5(glass) / other useful ior is 1.33(water)
	groundRectangle.material.clearcoat = 0.0; // range: 0.0 to 1.0 / default is 0.0 (no clearcoat)
